			...
			if (mysqli_num_rows($result)==1) {
				...
				if ($row['password']==sha1(md5($password))) {
					if ($row['status']=='activo') {
						...
						$status_inactive = "Su estado está inactivo, póngase en contacto con el administrador";
					}
				}else{
...
<html lang="es">
  ...
  <body>
    <div class=""><br>
          <h1 class="text-center">Escuela Primaria San Miguel</h1><hr><br> 
            ...
            <div class="col-md-4 offset-md-4">
             	<form method="POST" action="">
				  ...
				  <div class="text-center">
				      <button type="submit" name="login" class="btn btn-warning">Iniciar sesión</button>
				    </div>
				    <p>Si aún no tienes una cuenta de usuario, puedes <a href="register.php">Registrarte Aquí</a></p>
				  </div>
				</form>
            </div>
          </div>
