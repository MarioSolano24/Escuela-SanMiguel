...
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Agregar Nuevo Estudiante<small class="text-warning"> </small></h1>
...
<div class="col-sm-6">
	...
	<div role="alert" aria-live="assertive" aria-atomic="true" class="toast fade" data-autohide="true" data-animation="true" data-delay="2000">
	  <div class="toast-header">
	    <strong class="mr-auto">Estudiante Agregado Exitosamente</strong>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="roll" type="text" value="<?= isset($roll)? $roll: '' ; ?>" class="form-control" pattern="[0-9]{8}" id="roll"  placeholder="Solo ingrese 8 numero" required="">
	  	</div>
	  	<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="[0-9]{10}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="+52.." required="">
	  	</div>
	  	<div class="form-group">
		    <label for="class">Seleccione su Grado</label>
