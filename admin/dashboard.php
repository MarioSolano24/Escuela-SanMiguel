...
<h1><a href="index.php"><i class="fas fa-tachometer-alt"></i>  Vista General </a> <small></small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user"></i> Solano Cruz</li>
  </ol>
</nav>
  ...
  <div class="col-sm-4">
     <div class="card text-white bg-primary mb-3">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="float-sm-right">Numero de Estudiantes</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
        <div class="row">
          <div class="col-sm-8">
            <p class="">Consultas  Estudiantes</p>
          </div>
          <div class="col-sm-4">
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="clearfix"></div>
            <div class="float-sm-right">Numero de Usuarios</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
