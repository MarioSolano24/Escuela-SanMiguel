...
<br>
          ...
          <div class="col-md-3">
            <div class="list-group">
              <a href="index.php?page=dashboard" class="list-group-item list-group-item-action active">
               <i class="fas fa-tachometer-alt"></i> Menu de Opciones
              </a>
              ...
              <a href="index.php?page=all-student" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> Tabla de todos los Estudiantes</a>
              <a href="index.php?page=all-users" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> Tabla de todos los Usuarios</a>
    ...
    <div class="clearfix"></div>
      ...
      <center><h3>VISITAMOS NUESTRA ESCUELA EN LA SIGUIENTE LIGA  <a href="https://www.voaxaca.tecnm.mx/">ITVO</a></h3></center>
